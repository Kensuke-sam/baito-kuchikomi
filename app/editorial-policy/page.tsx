...
const policyItems = [
  ...
  {
    title: "安全性を優先する",
    body: "広告や求人比較ページは設けていますが、投稿フォーム、削除依頼、ガイドラインなど重要なページでは誤解を招く配置を避けます。",
  },
] as const;
    ...
    <main className="app-shell mx-auto max-w-4xl px-4 py-8 sm:py-10">
      <section className="section-frame p-6 sm:p-8">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--page-muted)]">
          労働や職場の評判は、書き方ひとつで法的リスクが大きく変わります。バイト体験談マップでは、主観投稿として読めること、個人を特定しないこと、問題があれば見直せることを基準に公開判断を行います。
        </p>
