...
const sections = [
  ...
  {
    title: "対応窓口",
    body: "掲載内容に問題がある場合は通報フォームと削除申請フォームをご利用ください。勤務先の当事者・企業からの訂正や反論は、当事者コメントフォームから受け付けています。個別の法務相談や労務相談を受けるページではありません。",
  },
  {
    title: "広告表示と安全性",
    body: "ガイド、口コミ、求人比較を行き来できる構成ですが、PR を含むページでは広告であることを明記し、削除・訂正の窓口も分かる位置に残します。",
  },
] as const;
